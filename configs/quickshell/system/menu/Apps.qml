...
// Search bar (toggleable)
    ...
    ColumnLayout {
        Layout.fillWidth: true
        spacing: 4
        visible: (appsRoot.enableSearch ? searchField.text.length === 0 : true) && appsRoot.showMostUsed
        Rectangle {
            Layout.leftMargin: 2
            Layout.fillWidth: true
            height: 12
